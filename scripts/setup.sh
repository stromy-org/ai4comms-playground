...
echo ""
echo "You now have:"
echo "  - Submodules initialized (global-skills, duke-strategies-plugin)"
echo "  - Global skills available (conventional-commit, skill-creator)"
echo "  - 14 shared skills synced from Cowork (auto-updated via GitHub Actions)"
echo "  - Git hooks configured (upstream/ write protection)"
echo "  - Dependencies installed"
echo ""
echo "Get started:"
echo "  - Browse available skills:  ls .claude/skills/"
